...
namespace SmartSchool.WebAPI.Data
{
    public class SmartContext : DbContext 
    {
        ...
        // Criar a referência das classes para criar as tabelas 
        ...
        // Este método é executado quando estiver sendo criado o banco de dados
        protected override void OnModelCreating(ModelBuilder builder)
        {
            // REFERÊNCIA DE CHAVE ESTRANGEIRA FOREIGN KEY
            ...
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    ...
                    new Disciplina(4, "Inglês", 4, 2),
                    new Disciplina(5, "Programação", 5, 1),
                    new Disciplina(6, "Algorítmos", 5, 2),
                    new Disciplina(7, "Arquitetura de Computadores", 5, 2),
                    new Disciplina(8, "ASP.NET Core 5", 5, 3),
                    new Disciplina(9, "SQL Server", 5, 3),
                    new Disciplina(10, "Gestão de TI", 5, 1),
                });
            
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("20/03/2002")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("20/03/2002")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("20/03/2002")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("20/03/2002")),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("20/03/2002")),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("20/03/2002")),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Parse("20/03/2002"))
                });
